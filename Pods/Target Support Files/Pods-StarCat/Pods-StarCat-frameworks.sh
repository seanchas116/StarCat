...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-StarCat/ReactiveFoundation.framework"
  install_framework "Pods-StarCat/ReactiveKit.framework"
  install_framework "Pods-StarCat/ReactiveUIKit.framework"
